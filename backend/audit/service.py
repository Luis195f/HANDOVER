...
def _sanitize_resource_id(resource_type: str, resource_id: str) -> str:
    if (resource_type or "").strip() != "Patient":
        return resource_id
    return build_audit_patient_key(resource_id)
...
def emit_audit_event(
    *,
    ...
    try:
        ...
        sanitized_resource_id = _sanitize_resource_id(resource_type, resource_id)
        ...
        log_payload = {
            ...
            **{k: v for k, v in event_data.items() if k != "meta" and v is not None},
            "has_meta": bool(meta),
        }
