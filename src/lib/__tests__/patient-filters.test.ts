...
describe("patient-filters", () => {
  const pts: PatientRow[] = [
    { id: "001", name: "Ana Pérez", unitId: "uci", specialty: "intensivo", vitals: { rr: 16, spo2: 98, temp: 37, sbp: 120, hr: 80, o2: false, acvpu: "A" } }, // ~0
    { id: "002", name: "Luis Mora", unitId: "uci", specialty: "intensivo", vitals: { rr: 28, spo2: 90, temp: 39, sbp: 90, hr: 130, o2: true, acvpu: "V" } }, // alto
    { id: "abc-33", name: "Bea Gómez", unitId: "pediatria", specialty: "pediatria", vitals: { rr: 22, spo2: 94, temp: 38.4, sbp: 105, hr: 100, o2: false, acvpu: "A" } }, // leve/medio
    { id: "004", name: "Carlos Rey", unitId: "medicina", specialty: "clinica", news2: 5 }, // score precalculado
  ];
