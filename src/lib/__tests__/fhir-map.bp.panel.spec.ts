...
describe('Panel de Presión Arterial 85354-9 — componentes y coherencia', () => {
  ...
  it('emite panel por defecto cuando hay TAS/TAD (emitBpPanel undefined)', () => {
  ...
  it('emite BP panel 85354-9 con TAS/TAD cuando ambos están presentes', () => {
    ...
    // Individuales pueden omitirse cuando se emite sólo el panel
  });
  ...
  it('emite panel aunque emitBpPanel=false cuando hay TAS/TAD', () => {
  ...
  it('no requiere hasMember aunque emitHasMember=true', () => {
    const bundle = buildHandoverBundle(
