...
const PILOT_GRADE_SUITES = [
  ...
  'src/screens/__tests__/OnboardingScreen.web-confirm.spec.tsx',
  'src/screens/components/__tests__/SignaturesSection.demo-actors.spec.tsx',
  'src/screens/handover/__tests__/submission.spec.ts',
  'src/demo/__tests__/exception-handover.spec.ts',
  'src/demo/__tests__/launcher-branch-guard.spec.ts',
  'src/lib/__tests__/exception-handover.classification.spec.ts',
  'src/lib/__tests__/exception-handover-storage.spec.ts',
  'src/lib/__tests__/handoff-contract.spec.ts',
  'src/screens/handover/__tests__/UnitExceptionHandover.spec.tsx',
  'tests/lib/summary.spec.ts',
