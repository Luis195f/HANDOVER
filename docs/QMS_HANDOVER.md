...
- **Software design & implementation** follows a separation of mobile frontend and Django backend, with clear API boundaries and security components. (`index.ts`, `App.tsx`, `backend/api/urls.py`, `backend/api/views.py`, `backend/security/auth.py`)
