...
| Auditoría backend (`AuditEvent` con hash de payload y sin cuerpo clínico) | `backend/audit/service.py`, `backend/audit/views.py`, `backend/api/views_ai.py` | `backend/audit/tests/test_audit.py` | `docs/SECURITY_HARDENING.md` |
