...
| Auditoría (hash sin PHI + `patientKey` seudonimizado en `/api/audit`) | `backend/audit/service.py`, `backend/audit/views.py`, `backend/api/views.py`, `backend/api/migrations/0014_pseudonymize_client_audit_patient_ids.py`, `src/lib/audit.ts`, `src/screens/AuditLogScreen.tsx`, `main.py` | `backend/audit/tests/test_audit.py`, `backend/api/tests/test_audit_log_models.py`, `tests/audit.spec.ts`, `tests/screens/AuditLogScreen.spec.tsx` | `docs/SECURITY_HARDENING.md` |
